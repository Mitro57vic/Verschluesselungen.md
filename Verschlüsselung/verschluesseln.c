...
char text_verschluesseln(char c, int n);
void bild_verschluesseln(int hoehe, int breite, RGBTRIPLE bild[hoehe][breite], int schluessel);
...
int main(int argc, char *argv[])
{
    if (strcmp(argv[1], "1") == 0 && argc == 4)
    {
        ...
        {
            printf("%c", text_verschluesseln(text[i], key));
        }
        printf("\n");
    }
    else if (strcmp(argv[1], "2") == 0 && argc == 5)
    {
        ...
        bild_verschluesseln(hoehe, breite, bild, key);
